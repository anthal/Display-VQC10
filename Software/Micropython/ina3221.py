...
# V 1.2
# Quelle: https://github.com/switchdoclabs/SDL_Pi_INA3221
...
class SDL_Pi_INA3221():
    ...
    def __init__(self, i2c, twi=1, addr=INA3221_ADDRESS, shunt_resistor = SHUNT_RESISTOR_VALUE  ):
        """
        """
        self.i2c = i2c
        self._addr = addr
    ...
    def _read_register_little_endian(self, register):
        """
        """
        result_byte = self.i2c.readfrom_mem(self._addr, register, 2)
        switchresult = int.from_bytes(result_byte, 'big') & 0xFFFF
    ...
    def _write_register_little_endian(self, register, data):
        """
        """
        switchdata = data & 0xFFFF
        # Bytetausch kann entfallen, da 'little' Parameter ist ?:
        #self.i2c.writeto_mem(self._addr, register, switchdata.to_bytes(2, 'little'))
        self.i2c.writeto_mem(self._addr, register, switchdata.to_bytes(2, 'big'))
